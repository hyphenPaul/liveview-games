defmodule GamesWeb.Router do
  ...
  import GamesWeb.UserAuth

  pipeline :browser do
    plug(:accepts, ["html"])
    plug(:fetch_session)
    plug(:fetch_live_flash)
    plug(:put_root_layout, html: {GamesWeb.Layouts, :root})
  ...
  if Application.compile_env(:games, :dev_routes) do
  ...
  scope "/", GamesWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{GamesWeb.UserAuth, :redirect_if_user_is_authenticated}] do
